      ...
      newVue:function(num){
        ...
        axios.interceptors.response.use(response => {
           ...
           // this.$store.commit('isloadhid');
            ...
            axios.get('https://ttcapi2.ttc178.com/api/sitemsg/getariclelist?c=1&v=1.0&t=1540456681&tk=&p=main&pageindex=' + num + '&category=SZC&s=cdfdd0026cdb71af5810e030ed05ea43')  /// http://www.hd.me/data.php?callback=dosomething    static/news.json?num  static/news.json  http://misc.opencai.net/consts/lotts.json   /static/news.json
            .then(res => {
